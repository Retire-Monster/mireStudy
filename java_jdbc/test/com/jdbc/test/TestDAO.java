...
public class TestDAO {
	...
	public void init() {
		...
		고객dao.setDateSource(dataSource);
		제품dao.setDateSource(dataSource);
		주문dao.setDateSource(dataSource);
	}
...
//	}
	...
	public void test고객리스트() throws Exception {
		...
		Assert.assertEquals(8, 고객리스트.size()); // import org.junit.Assert;
	}
	...
	public void test주문리스트() throws Exception {
		...
		Assert.assertEquals(9, 주문리스트.size());
	}
//	에러값이 콘솔에 나올 경우 테스트 설정이 잘못됨을 말한다.
}
